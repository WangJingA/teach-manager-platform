  ...
  <div>
    <div class="container">
      <div class="handle-box">
        <el-input v-model="query.uuid" placeholder="专业口令" class="handle-input mr10" ></el-input>
        <el-input v-model="query.majorName" placeholder="专业名" class="handle-input mr10" ></el-input>
        <el-select v-model="query.departmentUid" placeholder="学院名" class="handle-select mr10" @change="listSelect()">
      ...
      <el-table :data="tableData" border class="table" ref="multipleTable" header-cell-class-name="table-header">
        ...
        <el-table-column label="专业所属学院">
          <template #default="scope">{{ scope.row.departmentUid }}</template>
        </el-table-column>
        <el-table-column label="专业图标" align="center">
          <template #default="scope">
            <el-image
                class="table-td-thumb"
                :src="scope.row.majorIcon"
                :z-index="10"
                :preview-src-list="[scope.row.majorIcon]"
                preview-teleported
            >
            </el-image>
          </template>
...
import {listMajor} from "../../../api/Manager/MajorManageApi";
