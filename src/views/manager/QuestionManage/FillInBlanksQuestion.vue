    ...
    <div class="radio-question">
      <el-form ref="formRef" :rules="rules" :model="form" label-width="140px">
        ...
        <el-form-item label="题干" prop="name">
          <el-tooltip :content="question.questionTips" effect="light"  placement="top" >
            <el-input v-model="question.question" ></el-input>
          </el-tooltip>
        </el-form-item>
        <el-form-item label="标答" prop="desc">
          <!-- 文字提示-->
          <el-tooltip content="多个答案用 '-' 分隔" effect="light"  placement="top">
            <el-input type="textarea" rows="5" v-model="question.answer"></el-input>
          </el-tooltip>
        </el-form-item>
...
const question = reactive({
  questionTips:'题干创建模板：三国演绎的作者是_____,他是哪个朝代的人______',
  question:'',
  courseName:'',
  answer:'',
  score:0,
