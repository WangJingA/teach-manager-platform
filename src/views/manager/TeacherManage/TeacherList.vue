  ...
  <div>
    <div class="container">
      <div class="handle-box">
        <el-input v-model="query.name" placeholder="教师口令" class="handle-input mr10" ></el-input>
        ...
        <el-button type="primary" :icon="Plus" class="search-button" @click="addTeacher">新增</el-button>
