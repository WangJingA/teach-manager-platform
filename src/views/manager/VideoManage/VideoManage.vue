  ...
  <div>
    <div class="container">
      <div class="handle-box">
        ...
        <el-select v-model="query.address" placeholder="上下架？ " class="handle-select mr10">
          <el-option key="1" label="软件工程181" value="软件工程181"></el-option>
          <el-option key="2" label="软件工程182" value="软件工程182"></el-option>
        </el-select>
        <el-input v-model="query.name" placeholder="视频口令" class="handle-input mr10"></el-input>
      ...
      <el-table :data="tableData" border class="table" ref="multipleTable" header-cell-class-name="table-header">
        <el-table-column prop="id" label="视频口令" width="220" align="center"></el-table-column>
        <el-table-column prop="name" label="视频名"></el-table-column>
        <el-table-column label="视频描述">
          <template #default="scope">￥{{ scope.row.money }}</template>
        </el-table-column>
        <el-table-column prop="name" label="课程名称"></el-table-column>
        <el-table-column prop="name" label="试卷总分"></el-table-column>
        <el-table-column label="视频封面(查看大图)" align="center">
